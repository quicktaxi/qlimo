...
(function (s, q, t) {
  ...
  var f = "BUTTON A INPUT TEXTAREA SELECT DETAILS SUMMARY".split(" "),
    ...
    function c(c, n, d, e) {
      ...
      priority: 200, compile: function compile(f, n) {
        var d = h(n, f);return { pre: function pre(a, b, c, k) {
            "checkbox" === d && (k.$isEmpty = function (a) {
              return !1 === a;
            });
          }, post: function post(e, b, g, k) {
            function f() {
              return k.$modelValue;
            }function h(a) {
    ...
    return { restrict: "A", require: "?ngMessages", link: function link(a, c, f, h) {
        c.attr("aria-live") || c.attr("aria-live", "assertive");
      } };
  }).directive("ngClick", ["$aria", "$parse", function (a, c) {
    return { restrict: "A", compile: function compile(m, h) {
